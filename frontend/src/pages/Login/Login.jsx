      ...
      <div className='w-full p=6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input type="text" value={username} onChange={(e)=> setUsername(e.target.value)} placeholder='Enter Username' className='w-full input input-bordered h-18'/>
          </div>
          <div>
          ...
          <Link to='/signup' className='text-sm text-gray-200 hover:underline hover:text-gray-200 mt-2 inline-block'>
